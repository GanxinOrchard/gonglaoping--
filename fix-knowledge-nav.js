...
// 讀取檔案
const content = fs.readFileSync('knowledge.html', 'utf8');

// 舊的導覽列
const oldNav = `                <div class="main-menu" id="mainMenu">
                    <ul>
...
// 新的導覽列
const newNav = `                <div class="main-menu" id="mainMenu">
                    <ul>
                        <li><a href="index.html">首頁</a></li>
...
if (content.includes(oldNav)) {
    const newContent = content.replace(oldNav, newNav);
    fs.writeFileSync('knowledge.html', newContent, 'utf8');
    console.log('✅ knowledge.html 導覽列已更新！');
} else {
    console.log('❌ 找不到舊的導覽列');
}
